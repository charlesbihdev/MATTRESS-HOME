...
const FloatingButton = () => {
    return (
        <div className="group fixed right-16 bottom-6 p-2 flex items-end justify-end w-36 h-36">
            {/* Main Button */}
            <div className="text-white shadow-xl flex items-center justify-center p-3 rounded-full bg-gradient-to-r from-yellow-300 to-green-300 z-50 absolute">
                <img
            ...
            {/* Sub Button Left */}
            <Link
                href="https://wa.me/+233244281122?text=Hey,%20Tell%20us%20what%20you%20want"
